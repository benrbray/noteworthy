/* markdown-it-katex
 * (https://github.com/traPtitech/markdown-it-katex/blob/5875bbb7bfa22e76dd433dfdd6e7c7e012dcbd80/index.js)
 * 
 * A stripped down, simplified version of markdown-it-math (https://github.com/runarberg/markdown-it-math).
 */
...
const math_inline:RuleInline = (state:StateInline, silent:boolean) => {
...
export const math_plugin:MarkdownIt.PluginWithOptions = (md:MarkdownIt, pluginOptions?:IPluginOptions&KatexOptions) => {
	// Default options

	let options:(IPluginOptions & KatexOptions) = pluginOptions || {};
